...
srcdir = /Users/samkuhlmann/Projects/crockswap/vendor/bundle/gems/pg-0.18.4/ext
topdir = /Users/samkuhlmann/.rbenv/versions/2.3.0/include/ruby-2.3.0
hdrdir = $(topdir)
arch_hdrdir = /Users/samkuhlmann/.rbenv/versions/2.3.0/include/ruby-2.3.0/x86_64-darwin14
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/samkuhlmann/.rbenv/versions/2.3.0
...
DEFS     = 
CPPFLAGS = -DRUBY_EXTCONF_H=\"$(RUBY_EXTCONF_H)\" -I/usr/local/Cellar/postgresql/9.5.2/include -I/Users/samkuhlmann/.rbenv/versions/2.3.0/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) $(cxxflags) $(ARCH_FLAG)
ldflags  = -L. -L/Users/samkuhlmann/.rbenv/versions/2.3.0/lib  -fstack-protector -L/usr/local/lib -Wl,-rpath,/usr/local/lib
